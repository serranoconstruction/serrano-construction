    ...
    <div className="bg-white-400 p-6 text-gray-900 sm:p-12">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mb-6 text-lg text-gray-700">
          This privacy policy sets out how Serrano Construction uses and
          protects any information that you give Serrano Construction when you
          use this website. Serrano Construction is committed to ensuring that
          ...
          this privacy statement. Serrano Construction may change this policy
          ...
          policy is effective from January 1st, 2025.
        </p>
        ...
        <ul className="mb-6 list-inside list-disc">
          ...
          <li>
            ...
            by writing to or emailing us at serrano.construction@gmail.com.
          </li>
        </ul>
        ...
        <p className="mb-6 text-lg text-gray-700">
          ...
          to serrano.construction@gmail.com.
        </p>
